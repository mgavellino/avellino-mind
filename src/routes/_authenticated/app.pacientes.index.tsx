            ...
            {filtered.map((p) => (
              <li key={p.id} className="p-4">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-gradient-brand grid place-items-center text-sm font-medium text-white overflow-hidden shrink-0">
                    {p.avatar_url ? (
                ...
                <div className="mt-3 grid grid-cols-3 gap-2">
                  <Link
                    to="/app/pacientes/$id"
                    params={{ id: p.id }}
                    className="inline-flex items-center justify-center gap-1.5 h-9 rounded-lg border border-border/60 bg-surface text-xs"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-1.5 h-9 rounded-lg border border-destructive/30 text-destructive text-xs"
                  >
